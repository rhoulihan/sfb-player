...
- [x] **Boarding-party boxes at SSD verification — DONE 2026-07-19**: FED-CA (10) and KLI-D7 (14) verified by Rick;
  bpLeftOf uses verified counts (the complement-of-4 fallback remains only for ships not yet re-verified).
